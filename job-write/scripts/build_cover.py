...
支持类型：
  · **校招**（2027 届校园招聘 / A 线）→ `标准校招封面母版.png`
  · **社会招聘**（事业单位・高校编制招考 / B 线，以及企业社招）→ `标准社招封面母版.png`
  · **求职**（求职方法 / 职业规划类）→ `标准求职封面母版.png`

升学政策解读类不属于 job-write 范围，封面另行制定。

母版与胶囊规格（job-write §6.1~6.3，不得自创底版）：
...
if __name__ == "__main__":
    ...
    ap.add_argument("--type", required=True, choices=list(MASTERS), help="校招 / 社招 / 求职")
